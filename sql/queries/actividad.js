...
module.exports = {
  ...
  getParto: new PS(
    ...
    'SELECT cria.co_ganado, cria.id_tipo_ganado , cria.pe_ganado,' +
      ' padre.co_ganado co_pa_ganado, cria.id_pa_ganado, madre.co_ganado co_ma_ganado, cria.id_ma_ganado, de_tipo_ganado,' +
      ...
      'INNER JOIN tipo_ganado ON cria.id_tipo_ganado = tipo_ganado.id_tipo_ganado ' +
